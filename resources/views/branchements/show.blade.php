...
@section('content')
    <div class="container mx-auto py-8">
        ...
        <table class="min-w-full bg-white shadow-md rounded-lg overflow-hidden">
            ...
            <tbody class="text-gray-700">
                ...
                <tr class="border-t border-gray-200">
                    ...
                    <td class="py-3 px-4">{{ $branchement->abonnee->nom }}</td>
                </tr>
                ...
                <tr class="border-t border-gray-200">
                    ...
                    <td class="py-3 px-4">{{ $branchement->abonnee->adresse }}</td>
                </tr>
                <tr class="border-t border-gray-200">
        ...
        <a href="{{ route('branchements.pdf', $branchement->n_order) }}"
        ...
        <a href="{{ route('branchements.index') }}"
            class="inline-flex items-center px-4 py-2 bg-blue-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest shadow-sm hover:bg-blue-700 focus:outline-none focus:border-blue-700 focus:ring focus:ring-blue-200 disabled:opacity-25 transition mt-4">Back
            to
            Branchements</a>
    </div>
@endsection
