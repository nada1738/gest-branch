        ...
        <div class="w-full md:w-1/2">
            <form action="#" method="get">
                <div class="relative">
                    ...
                    <input type="search" id="searchInput" name="rechercher" class="block p-2 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg w-64 focus:ring-blue-500 focus:border-blue-500 outline-none" placeholder="Rechercher">
                </div>
            </form>
        </div>
        <div class="w-full md:w-auto flex flex-col md:flex-row space-y-2 md:space-y-0 items-stretch md:items-center justify-end md:space-x-3 flex-shrink-0">
            <a href="{{ route('reclamations.create') }}">
                <div type="button" class="flex items-center justify-center text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-4 py-2">
            ...
            <button id="exportBtn" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mt-4 md:mt-0">
                Export to Excel
            </button>
        </div>
    </div>
            ...
            <tbody>
                ...
                @foreach ($reclamations as $reclamation)
                    <tr class="bg-white border-b ">
                        ...
                        <td class="px-6 py-4">
                            {{ $reclamation->branchement->abonnee->adresse }}
                        </td>
                        <td class="px-6 py-4">
                            {{ $reclamation->branchement->abonnee->telephone }}
                        </td>
