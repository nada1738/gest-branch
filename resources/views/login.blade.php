                        ...
                        <div class="mt-8 h">
                            <form action="{{ route('login') }}" method="POST">
                                ...
                                <div class="mt-6 flex justify-center">
                                    ...
                                    <button type="submit"
                                        class="w-48 px-4 py-2 tracking-wide text-white transition-colors duration-200 transform rounded-md bg-blue-600 hover:bg-blue-400 focus:outline-none focus:bg-blue-400 focus:ring focus:ring-blue-300 focus:ring-opacity-50">
                                        Login
                                    </button>
